...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    children: [
      ...
      // Staff training content for the HBOT/PEMF/infrared clinics (see app/training/layout.tsx).
      { href: "/training", label: "Training", icon: GraduationCap, tenants: ["optimal-health", "renova"] },
