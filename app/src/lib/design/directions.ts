...
export const EDITORIAL: DesignDirection = {
  ...
  type: {
    ...
    body: { size: 24, leading: 1.5, tracking: 0, weight: 400 },
...
export const BOLD: DesignDirection = {
  ...
  type: {
    ...
    body: { size: 24, leading: 1.45, tracking: 0, weight: 500 },
...
export const CLINICAL: DesignDirection = {
  ...
  type: {
    ...
    body: { size: 23, leading: 1.55, tracking: 0, weight: 400 },
...
export const SWISS: DesignDirection = {
  ...
  type: {
    ...
    body: { size: 24, leading: 1.45, tracking: 0, weight: 400 },
...
export const EVIDENCE: DesignDirection = {
  ...
  type: {
    ...
    subhead: { size: 28, leading: 1.3, tracking: 0, weight: 500 },
    body: { size: 23, leading: 1.5, tracking: 0, weight: 400 },
